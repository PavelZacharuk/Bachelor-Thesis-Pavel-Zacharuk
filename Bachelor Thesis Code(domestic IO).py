...
io98 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 98.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io99 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 99.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io00 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 00.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io01 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 01.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io02 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 02.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io03 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 03.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io04 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 04.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io05 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 05.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io06 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 06.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io07 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 07.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io08 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 08.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io09 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 09.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io10 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 10.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
io11 = pd.read_csv('C:/Users/Pavel/Desktop/IES/Bachelor Thesis/data/OECD IO Tables/csv dom/IO 97-11 - IO - 11.csv', sep=',', header = 6, usecols=np.arange(2,45),skiprows = np.append(np.array([7,8],dtype=float),np.array([47])))
...
np.diag(np.array(newemp98.loc["Guangdong","1":"9"].div(newemp98.loc["Guangdong","Total"]), dtype = np.float))
...
# export to excel
#Guangdong
writer = pd.ExcelWriter('Possible_regional_output_Guangdong.xlsx') 
possible_Guangdong98.to_excel(writer, sheet_name='possible_Guangdong98_dom',index=False)
possible_Guangdong99.to_excel(writer, sheet_name='possible_Guangdong99_dom',index=False)
possible_Guangdong00.to_excel(writer, sheet_name='possible_Guangdong00_dom',index=False)
possible_Guangdong01.to_excel(writer, sheet_name='possible_Guangdong01_dom',index=False)
possible_Guangdong02.to_excel(writer, sheet_name='possible_Guangdong02_dom',index=False)
possible_Guangdong03.to_excel(writer, sheet_name='possible_Guangdong03_dom',index=False)
possible_Guangdong04.to_excel(writer, sheet_name='possible_Guangdong04_dom',index=False)
possible_Guangdong05.to_excel(writer, sheet_name='possible_Guangdong05_dom',index=False)
possible_Guangdong06.to_excel(writer, sheet_name='possible_Guangdong06_dom',index=False)
possible_Guangdong07.to_excel(writer, sheet_name='possible_Guangdong07_dom',index=False)
possible_Guangdong08.to_excel(writer, sheet_name='possible_Guangdong08_dom',index=False)
possible_Guangdong09.to_excel(writer, sheet_name='possible_Guangdong09_dom',index=False)
possible_Guangdong10.to_excel(writer, sheet_name='possible_Guangdong10_dom',index=False)
possible_Guangdong11.to_excel(writer, sheet_name='possible_Guangdong11_dom',index=False)
writer.save()
writer.close()

#Jiangsu
writer = pd.ExcelWriter('Possible_regional_output_Jiangsu.xlsx') 
possible_Jiangsu98.to_excel(writer, sheet_name='possible_Jiangsu98_dom', index=False) 
possible_Jiangsu99.to_excel(writer, sheet_name='possible_Jiangsu99_dom', index=False) 
possible_Jiangsu00.to_excel(writer, sheet_name='possible_Jiangsu00_dom', index=False) 
possible_Jiangsu01.to_excel(writer, sheet_name='possible_Jiangsu01_dom', index=False) 
possible_Jiangsu02.to_excel(writer, sheet_name='possible_Jiangsu02_dom', index=False) 
possible_Jiangsu03.to_excel(writer, sheet_name='possible_Jiangsu03_dom', index=False) 
possible_Jiangsu04.to_excel(writer, sheet_name='possible_Jiangsu04_dom', index=False) 
possible_Jiangsu05.to_excel(writer, sheet_name='possible_Jiangsu05_dom', index=False) 
possible_Jiangsu06.to_excel(writer, sheet_name='possible_Jiangsu06_dom', index=False) 
possible_Jiangsu07.to_excel(writer, sheet_name='possible_Jiangsu07_dom', index=False) 
possible_Jiangsu08.to_excel(writer, sheet_name='possible_Jiangsu08_dom', index=False) 
possible_Jiangsu09.to_excel(writer, sheet_name='possible_Jiangsu09_dom', index=False) 
possible_Jiangsu10.to_excel(writer, sheet_name='possible_Jiangsu10_dom', index=False) 
possible_Jiangsu11.to_excel(writer, sheet_name='possible_Jiangsu11_dom', index=False) 
writer.save()
writer.close()

#Gansu
writer = pd.ExcelWriter('Possible_regional_output_Gansu.xlsx') 
possible_Gansu98.to_excel(writer, sheet_name='possible_Gansu98_dom', index=False) 
possible_Gansu99.to_excel(writer, sheet_name='possible_Gansu99_dom', index=False) 
possible_Gansu00.to_excel(writer, sheet_name='possible_Gansu00_dom', index=False) 
possible_Gansu01.to_excel(writer, sheet_name='possible_Gansu01_dom', index=False) 
possible_Gansu02.to_excel(writer, sheet_name='possible_Gansu02_dom', index=False) 
possible_Gansu03.to_excel(writer, sheet_name='possible_Gansu03_dom', index=False) 
possible_Gansu04.to_excel(writer, sheet_name='possible_Gansu04_dom', index=False) 
possible_Gansu05.to_excel(writer, sheet_name='possible_Gansu05_dom', index=False) 
possible_Gansu06.to_excel(writer, sheet_name='possible_Gansu06_dom', index=False) 
possible_Gansu07.to_excel(writer, sheet_name='possible_Gansu07_dom', index=False) 
possible_Gansu08.to_excel(writer, sheet_name='possible_Gansu08_dom', index=False) 
possible_Gansu09.to_excel(writer, sheet_name='possible_Gansu09_dom', index=False) 
possible_Gansu10.to_excel(writer, sheet_name='possible_Gansu10_dom', index=False) 
possible_Gansu11.to_excel(writer, sheet_name='possible_Gansu11_dom', index=False) 
writer.save()
writer.close()

#Qinghai
writer = pd.ExcelWriter('Possible_regional_output_Qinghai.xlsx') 
possible_Qinghai98.to_excel(writer, sheet_name='possible_Qinghai98_dom', index=False) 
possible_Qinghai99.to_excel(writer, sheet_name='possible_Qinghai99_dom', index=False) 
possible_Qinghai00.to_excel(writer, sheet_name='possible_Qinghai00_dom', index=False) 
possible_Qinghai01.to_excel(writer, sheet_name='possible_Qinghai01_dom', index=False) 
possible_Qinghai02.to_excel(writer, sheet_name='possible_Qinghai02_dom', index=False) 
possible_Qinghai03.to_excel(writer, sheet_name='possible_Qinghai03_dom', index=False) 
possible_Qinghai04.to_excel(writer, sheet_name='possible_Qinghai04_dom', index=False) 
possible_Qinghai05.to_excel(writer, sheet_name='possible_Qinghai05_dom', index=False) 
possible_Qinghai06.to_excel(writer, sheet_name='possible_Qinghai06_dom', index=False) 
possible_Qinghai07.to_excel(writer, sheet_name='possible_Qinghai07_dom', index=False) 
possible_Qinghai08.to_excel(writer, sheet_name='possible_Qinghai08_dom', index=False) 
possible_Qinghai09.to_excel(writer, sheet_name='possible_Qinghai09_dom', index=False) 
possible_Qinghai10.to_excel(writer, sheet_name='possible_Qinghai10_dom', index=False) 
possible_Qinghai11.to_excel(writer, sheet_name='possible_Qinghai11_dom', index=False) 
writer.save()
writer.close()
...
#Exporting into excel, final consumption
#Guangdong
writer = pd.ExcelWriter('Possible_Final_consumption_Guangdong.xlsx') 
gdp_possible_Guangdong98.to_excel(writer, sheet_name='FC98', index=False) 
gdp_possible_Guangdong99.to_excel(writer, sheet_name='FC99', index=False) 
gdp_possible_Guangdong00.to_excel(writer, sheet_name='FC00', index=False) 
gdp_possible_Guangdong01.to_excel(writer, sheet_name='FC01', index=False) 
gdp_possible_Guangdong02.to_excel(writer, sheet_name='FC02', index=False) 
gdp_possible_Guangdong03.to_excel(writer, sheet_name='FC03', index=False) 
gdp_possible_Guangdong04.to_excel(writer, sheet_name='FC04', index=False) 
gdp_possible_Guangdong05.to_excel(writer, sheet_name='FC05', index=False) 
gdp_possible_Guangdong06.to_excel(writer, sheet_name='FC06', index=False) 
gdp_possible_Guangdong07.to_excel(writer, sheet_name='FC07', index=False) 
gdp_possible_Guangdong08.to_excel(writer, sheet_name='FC08', index=False) 
gdp_possible_Guangdong09.to_excel(writer, sheet_name='FC09', index=False) 
gdp_possible_Guangdong10.to_excel(writer, sheet_name='FC10', index=False) 
gdp_possible_Guangdong11.to_excel(writer, sheet_name='FC11', index=False) 
writer.save()
writer.close()

#Gansu
writer = pd.ExcelWriter('Possible_Final_consumption_Gansu.xlsx') 
gdp_possible_Gansu98.to_excel(writer, sheet_name='FC98', index=False) 
gdp_possible_Gansu99.to_excel(writer, sheet_name='FC99', index=False) 
gdp_possible_Gansu00.to_excel(writer, sheet_name='FC00', index=False) 
gdp_possible_Gansu01.to_excel(writer, sheet_name='FC01', index=False) 
gdp_possible_Gansu02.to_excel(writer, sheet_name='FC02', index=False) 
gdp_possible_Gansu03.to_excel(writer, sheet_name='FC03', index=False) 
gdp_possible_Gansu04.to_excel(writer, sheet_name='FC04', index=False) 
gdp_possible_Gansu05.to_excel(writer, sheet_name='FC05', index=False) 
gdp_possible_Gansu06.to_excel(writer, sheet_name='FC06', index=False) 
gdp_possible_Gansu07.to_excel(writer, sheet_name='FC07', index=False) 
gdp_possible_Gansu08.to_excel(writer, sheet_name='FC08', index=False) 
gdp_possible_Gansu09.to_excel(writer, sheet_name='FC09', index=False) 
gdp_possible_Gansu10.to_excel(writer, sheet_name='FC10', index=False) 
gdp_possible_Gansu11.to_excel(writer, sheet_name='FC11', index=False) 
writer.save()
writer.close()

#Jiangsu
writer = pd.ExcelWriter('Possible_Final_consumption_Jiangsu.xlsx') 
gdp_possible_Jiangsu98.to_excel(writer, sheet_name='FC98', index=False) 
gdp_possible_Jiangsu99.to_excel(writer, sheet_name='FC99', index=False) 
gdp_possible_Jiangsu00.to_excel(writer, sheet_name='FC00', index=False) 
gdp_possible_Jiangsu01.to_excel(writer, sheet_name='FC01', index=False) 
gdp_possible_Jiangsu02.to_excel(writer, sheet_name='FC02', index=False) 
gdp_possible_Jiangsu03.to_excel(writer, sheet_name='FC03', index=False) 
gdp_possible_Jiangsu04.to_excel(writer, sheet_name='FC04', index=False) 
gdp_possible_Jiangsu05.to_excel(writer, sheet_name='FC05', index=False) 
gdp_possible_Jiangsu06.to_excel(writer, sheet_name='FC06', index=False) 
gdp_possible_Jiangsu07.to_excel(writer, sheet_name='FC07', index=False) 
gdp_possible_Jiangsu08.to_excel(writer, sheet_name='FC08', index=False) 
gdp_possible_Jiangsu09.to_excel(writer, sheet_name='FC09', index=False) 
gdp_possible_Jiangsu10.to_excel(writer, sheet_name='FC10', index=False) 
gdp_possible_Jiangsu11.to_excel(writer, sheet_name='FC11', index=False) 
writer.save()
writer.close()

#Qinghai
writer = pd.ExcelWriter('Possible_Final_consumption_Qinghai.xlsx') 
gdp_possible_Qinghai98.to_excel(writer, sheet_name='FC98', index=False) 
gdp_possible_Qinghai99.to_excel(writer, sheet_name='FC99', index=False) 
gdp_possible_Qinghai00.to_excel(writer, sheet_name='FC00', index=False) 
gdp_possible_Qinghai01.to_excel(writer, sheet_name='FC01', index=False) 
gdp_possible_Qinghai02.to_excel(writer, sheet_name='FC02', index=False) 
gdp_possible_Qinghai03.to_excel(writer, sheet_name='FC03', index=False) 
gdp_possible_Qinghai04.to_excel(writer, sheet_name='FC04', index=False) 
gdp_possible_Qinghai05.to_excel(writer, sheet_name='FC05', index=False) 
gdp_possible_Qinghai06.to_excel(writer, sheet_name='FC06', index=False) 
gdp_possible_Qinghai07.to_excel(writer, sheet_name='FC07', index=False) 
gdp_possible_Qinghai08.to_excel(writer, sheet_name='FC08', index=False) 
gdp_possible_Qinghai09.to_excel(writer, sheet_name='FC09', index=False) 
gdp_possible_Qinghai10.to_excel(writer, sheet_name='FC10', index=False) 
gdp_possible_Qinghai11.to_excel(writer, sheet_name='FC11', index=False) 
writer.save()
writer.close()

#Export into excel regional A matrices
#Guangdong
writer = pd.ExcelWriter('Possible_regional_A_Guangdong.xlsx') 
ntio98_Guangdong.to_excel(writer, sheet_name='A98', index=False) 
ntio99_Guangdong.to_excel(writer, sheet_name='A99', index=False) 
ntio00_Guangdong.to_excel(writer, sheet_name='A00', index=False) 
ntio01_Guangdong.to_excel(writer, sheet_name='A01', index=False) 
ntio02_Guangdong.to_excel(writer, sheet_name='A02', index=False) 
ntio03_Guangdong.to_excel(writer, sheet_name='A03', index=False) 
ntio04_Guangdong.to_excel(writer, sheet_name='A04', index=False) 
ntio05_Guangdong.to_excel(writer, sheet_name='A05', index=False) 
ntio06_Guangdong.to_excel(writer, sheet_name='A06', index=False) 
ntio07_Guangdong.to_excel(writer, sheet_name='A07', index=False) 
ntio08_Guangdong.to_excel(writer, sheet_name='A08', index=False) 
ntio09_Guangdong.to_excel(writer, sheet_name='A09', index=False) 
ntio10_Guangdong.to_excel(writer, sheet_name='A10', index=False) 
ntio11_Guangdong.to_excel(writer, sheet_name='A11', index=False) 
writer.save()
writer.close()

#Gansu
writer = pd.ExcelWriter('Possible_regional_A_Gansu.xlsx') 
ntio98_Gansu.to_excel(writer, sheet_name='A98', index=False) 
ntio99_Gansu.to_excel(writer, sheet_name='A99', index=False) 
ntio00_Gansu.to_excel(writer, sheet_name='A00', index=False) 
ntio01_Gansu.to_excel(writer, sheet_name='A01', index=False) 
ntio02_Gansu.to_excel(writer, sheet_name='A02', index=False) 
ntio03_Gansu.to_excel(writer, sheet_name='A03', index=False) 
ntio04_Gansu.to_excel(writer, sheet_name='A04', index=False) 
ntio05_Gansu.to_excel(writer, sheet_name='A05', index=False) 
ntio06_Gansu.to_excel(writer, sheet_name='A06', index=False) 
ntio07_Gansu.to_excel(writer, sheet_name='A07', index=False) 
ntio08_Gansu.to_excel(writer, sheet_name='A08', index=False) 
ntio09_Gansu.to_excel(writer, sheet_name='A09', index=False) 
ntio10_Gansu.to_excel(writer, sheet_name='A10', index=False) 
ntio11_Gansu.to_excel(writer, sheet_name='A11', index=False) 
writer.save()
writer.close()

#Jiangsu
writer = pd.ExcelWriter('Possible_regional_A_Jiangsu.xlsx') 
ntio98_Jiangsu.to_excel(writer, sheet_name='A98', index=False) 
ntio99_Jiangsu.to_excel(writer, sheet_name='A99', index=False) 
ntio00_Jiangsu.to_excel(writer, sheet_name='A00', index=False) 
ntio01_Jiangsu.to_excel(writer, sheet_name='A01', index=False) 
ntio02_Jiangsu.to_excel(writer, sheet_name='A02', index=False) 
ntio03_Jiangsu.to_excel(writer, sheet_name='A03', index=False) 
ntio04_Jiangsu.to_excel(writer, sheet_name='A04', index=False) 
ntio05_Jiangsu.to_excel(writer, sheet_name='A05', index=False) 
ntio06_Jiangsu.to_excel(writer, sheet_name='A06', index=False) 
ntio07_Jiangsu.to_excel(writer, sheet_name='A07', index=False) 
ntio08_Jiangsu.to_excel(writer, sheet_name='A08', index=False) 
ntio09_Jiangsu.to_excel(writer, sheet_name='A09', index=False) 
ntio10_Jiangsu.to_excel(writer, sheet_name='A10', index=False) 
ntio11_Jiangsu.to_excel(writer, sheet_name='A11', index=False) 
writer.save()
writer.close()

#Qinghai
writer = pd.ExcelWriter('Possible_regional_A_Qinghai.xlsx') 
ntio98_Qinghai.to_excel(writer, sheet_name='A98', index=False) 
ntio99_Qinghai.to_excel(writer, sheet_name='A99', index=False) 
ntio00_Qinghai.to_excel(writer, sheet_name='A00', index=False) 
ntio01_Qinghai.to_excel(writer, sheet_name='A01', index=False) 
ntio02_Qinghai.to_excel(writer, sheet_name='A02', index=False) 
ntio03_Qinghai.to_excel(writer, sheet_name='A03', index=False) 
ntio04_Qinghai.to_excel(writer, sheet_name='A04', index=False) 
ntio05_Qinghai.to_excel(writer, sheet_name='A05', index=False) 
ntio06_Qinghai.to_excel(writer, sheet_name='A06', index=False) 
ntio07_Qinghai.to_excel(writer, sheet_name='A07', index=False) 
ntio08_Qinghai.to_excel(writer, sheet_name='A08', index=False) 
ntio09_Qinghai.to_excel(writer, sheet_name='A09', index=False) 
ntio10_Qinghai.to_excel(writer, sheet_name='A10', index=False) 
ntio11_Qinghai.to_excel(writer, sheet_name='A11', index=False) 
writer.save()
writer.close()

#Export into excel national A matrices
writer = pd.ExcelWriter('Possible_national_A_Guangdong.xlsx') 
A98.to_excel(writer, sheet_name='nA98', index=False) 
A99.to_excel(writer, sheet_name='nA99', index=False) 
A00.to_excel(writer, sheet_name='nA00', index=False) 
A01.to_excel(writer, sheet_name='nA01', index=False) 
A02.to_excel(writer, sheet_name='nA02', index=False) 
A03.to_excel(writer, sheet_name='nA03', index=False) 
A04.to_excel(writer, sheet_name='nA04', index=False) 
A05.to_excel(writer, sheet_name='nA05', index=False) 
A06.to_excel(writer, sheet_name='nA06', index=False) 
A07.to_excel(writer, sheet_name='nA07', index=False) 
A08.to_excel(writer, sheet_name='nA08', index=False) 
A09.to_excel(writer, sheet_name='nA09', index=False) 
A10.to_excel(writer, sheet_name='nA10', index=False) 
A11.to_excel(writer, sheet_name='nA11', index=False) 
writer.save()
writer.close()
